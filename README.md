...
A curated list of papers that **define, analyze, or evaluate geospatial embeddings** —  
how spatial, temporal, or semantic Earth data are represented in embedding space,  
and how those embeddings behave or are applied.
...
| Abbr. | Title | Publication | Paper | Link |
|-------|--------|-------------|--------|------|
...
## 🧠 3. Evaluation and Analysis of Embeddings
...
## 🏆 4. Open Challenges and Competitions
...
## 🌎 5. Applications of Geospatial Embeddings
